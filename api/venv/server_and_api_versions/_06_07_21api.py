...
def get_HW_devices_status(real_HW_devices_dict_ready_or_not,client_inputs_dict):
    ...
    try:
        ...
        spectrometer.integra
        tion_time_micros(client_inputs_dict["integration_time"])
    ...
    try:
        ...
        grbl = serial.Serial('COM3', 115200)
