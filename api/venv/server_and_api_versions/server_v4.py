""""
Here we changed:
Using base_page base_7 that uses React scripts ( placed in templates directory - the same root dir)
"""
...
import functools
from flask import Flask, make_response,render_template, request , flash ,json
app = Flask(__name__)
api = Api(app)
#from HW_devices_status import HW_devices_dict_ready_or_not
