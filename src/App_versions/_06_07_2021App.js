...
import './style.css';
import volcani_img from './volcani_img.png';
...
<table style={{width: "100%"}}>
	...
	<tr>
		...
		{/* <td className="auto-style1">Timer #2F<br /> </td>*/}
		{/*
		<td> 
		<img alt='Volcani Symbole' src={require('./volcani_img_3.png')}/>
		</td>
		*/}
		<td>
			<center> 
			<img src={volcani_img} alt= "Volcani Symb"/>
			</center>
		</td>
	...
	<tr>
		...
		<td rowspan="2">
			...
			<div className="auto-style1">
				<br />
				<input 
				name="Submit1" style={{ backgroundColor: "Green" , width: "120px" , height: "60px", fontWeight: "bold", fontSize:14}}  type="submit" value="Activate" /><br />
			</div>
